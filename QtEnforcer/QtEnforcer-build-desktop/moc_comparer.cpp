...
static const char qt_meta_stringdata_Comparer[] = {
    ...
    "results\0signal_ComparisonDone(QStringList*)\0"
    "cols\0slot_SetComparedColumns(QList<int>&)\0"
...
int Comparer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: signal_ComparisonDone((*reinterpret_cast< QStringList*(*)>(_a[1]))); break;
        case 3: slot_SetComparedColumns((*reinterpret_cast< QList<int>(*)>(_a[1]))); break;
...
// SIGNAL 2
void Comparer::signal_ComparisonDone(QStringList * _t1)
{

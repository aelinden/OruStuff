...
public partial class MainWindow: Gtk.Window
{
	...
	protected virtual void OnExecButtonClicked (object sender, System.EventArgs e)
	{
		...
		// Enable View and Save buttons, print status message.
		SBar.Pop(sbID);
		SBar.Push(sbID, "File parsed. Press View to view results or Save to save results to file.");
	...
	protected virtual void OnOpenButtonClicked (object sender, System.EventArgs e)
	{
		...
		parser.setIOFiles(chooser.Filename, resultFileName);
        
		// Print status message
		SBar.Pop(sbID); // Pop top message from statusbar.
		SBar.Push(sbID, "File opened. Press Parse to process file"); // Push new message onto statusbar.	
	...
	{
		string aboutText = "The Peer nomination Program (PnP) aka The Anders Program " + 
